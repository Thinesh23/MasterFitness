package com.example.masterfitness.DAO;

import android.content.Context;
import android.os.Environment;

import com.example.masterfitness.csvreader.CsvReader;
import com.example.masterfitness.csvreader.CsvWriter;
...
public class CVSManager {
    ...
    public boolean exportDatabase(Profile pProfile) {
        ...
        if (!Environment.MEDIA_MOUNTED.equals(state)) {
            ...
            //We use the MasterFitness directory for saving our .csv file.
            File exportDir = Environment.getExternalStoragePublicDirectory("/MasterFitness/export/" + dateFormat.format(date) + pProfile.getName());
            if (!exportDir.exists()) {
                exportDir.mkdirs();
            }
