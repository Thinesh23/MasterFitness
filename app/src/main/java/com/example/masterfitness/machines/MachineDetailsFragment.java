package com.example.masterfitness.machines;
...
import com.example.masterfitness.utils.RealPathUtil;
        ...
        switch (requestCode) {
            ...
            case CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    // Déplacer le fichier dans le repertoire de MasterFitness
                    ...
                    if (!Environment.MEDIA_MOUNTED.equals(state)) {
                        ...
                        storageDir = Environment.getExternalStoragePublicDirectory("/MasterFitness/Camera/");
