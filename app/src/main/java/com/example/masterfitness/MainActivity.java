package com.example.masterfitness;
...
import com.example.masterfitness.DAO.CVSManager;
import com.example.masterfitness.DAO.DAOCardio;
import com.example.masterfitness.DAO.DAOFonte;
import com.example.masterfitness.DAO.DAOMachine;
import com.example.masterfitness.DAO.DAOProfil;
import com.example.masterfitness.DAO.DAOStatic;
import com.example.masterfitness.DAO.DatabaseHelper;
import com.example.masterfitness.DAO.Fonte;
import com.example.masterfitness.DAO.Machine;
import com.example.masterfitness.DAO.Profile;
import com.example.masterfitness.DAO.cardio.DAOOldCardio;
import com.example.masterfitness.DAO.cardio.OldCardio;
import com.example.masterfitness.bodymeasures.BodyPartListFragment;
import com.example.masterfitness.fonte.FontesPagerFragment;
import com.example.masterfitness.intro.MainIntroActivity;
import com.example.masterfitness.machines.MachineFragment;
import com.example.masterfitness.utils.CustomExceptionHandler;
import com.example.masterfitness.utils.DateConverter;
import com.example.masterfitness.utils.FileChooserDialog;
import com.example.masterfitness.utils.ImageUtil;
import com.example.masterfitness.utils.MusicController;
import com.example.masterfitness.utils.UnitConverter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            File folder = new File(Environment.getExternalStorageDirectory() + "/MasterFitness");
            boolean success = true;
            if (!folder.exists()) {
                success = folder.mkdir();
            }
            if (success) {
                folder = new File(Environment.getExternalStorageDirectory() + "/MasterFitness/crashreport");
                success = folder.mkdir();
            }
            ...
            if (folder.exists()) {
                if (!(Thread.getDefaultUncaughtExceptionHandler() instanceof CustomExceptionHandler)) {
                    Thread.setDefaultUncaughtExceptionHandler(new CustomExceptionHandler(
                        Environment.getExternalStorageDirectory() + "/MasterFitness/crashreport"));
                }
            }
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.import_database:
                ...
                fileChooserDialog.chooseDirectory(Environment.getExternalStorageDirectory() + "/MasterFitness/export");
                return true;
